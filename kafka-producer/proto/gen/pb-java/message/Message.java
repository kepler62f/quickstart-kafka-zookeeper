...
public final class Message {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return message.Message.internal_static_message_Transaction_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return message.Message.internal_static_message_Transaction_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              message.Message.Transaction.class, message.Message.Transaction.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof message.Message.Transaction)) {
        return super.equals(obj);
      }
      message.Message.Transaction other = (message.Message.Transaction) obj;
    ...
    public static message.Message.Transaction parseFrom(
    ...
    public static message.Message.Transaction parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static message.Message.Transaction parseFrom(
    ...
    public static message.Message.Transaction parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static message.Message.Transaction parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static message.Message.Transaction parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(message.Message.Transaction prototype) {
    ...
    public static final class Builder extends
        ...
        message.Message.TransactionOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return message.Message.internal_static_message_Transaction_descriptor;
      }
      ...
      // Construct using message.Message.Transaction.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public message.Message.Transaction getDefaultInstanceForType() {
        return message.Message.Transaction.getDefaultInstance();
      }

      @java.lang.Override
      public message.Message.Transaction build() {
        message.Message.Transaction result = buildPartial();
      ...
      @java.lang.Override
      public message.Message.Transaction buildPartial() {
        message.Message.Transaction result = new message.Message.Transaction(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof message.Message.Transaction) {
          return mergeFrom((message.Message.Transaction)other);
        } else {
      ...
      public Builder mergeFrom(message.Message.Transaction other) {
        if (other == message.Message.Transaction.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        message.Message.Transaction parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (message.Message.Transaction) e.getUnfinishedMessage();
  ...
  bitField0_ |= 0x00000004;
    ...
    private static final message.Message.Transaction DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new message.Message.Transaction();
    }

    public static message.Message.Transaction getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "nsaction_id\030\001 \001(\t\022\026\n\016account_number\030\002 \001(" +
      "\t\022\035\n\025transaction_reference\030\003 \001(\t\0228\n\024tran" +
      "saction_datetime\030\004 \001(\0132\032.google.protobuf" +
